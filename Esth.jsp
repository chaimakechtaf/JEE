...
<body>
    ...
    <div class="jumbotron jumbotron-fluid bg-jumbotron" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h3 class="text-white display-3 mb-4">Aesthetics</h1>
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"><a class="text-white" href="acceuil.jsp">Home</a></p>
                <i class="far fa-circle px-3"></i>
                <p class="m-0"><a class="text-white" href="">aesthetics</a></p>
            </div>
        </div>
    </div>
    <!-- Header End -->
            ...
            <div class="row g-4">
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="feature-item bg-light rounded text-center p-4">
                        <img src="img/manicura-t.jpg.webp" style="width: 300px;height: 300px;margin-left:2'px ; padding: 5px;">
                        <br>
                        <h6  class="d-inline-block bg-light  text-uppercase py-1 px-2">Manicure</h6>
                    
                    </div>
                </div>
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="feature-item bg-light rounded text-center p-4">
                       <img src="img/amal.jpeg" style="width: 300px;height: 300px;margin-left:5px ; padding: 5px;">                        <br>
                        <h6  class="d-inline-block bg-light  text-uppercase py-1 px-2">Pedicure</h6>
                     
                    </div>
                </div>
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="feature-item bg-light rounded text-center p-4">
                        <img src="img/service-6.jpg" style="width: 300px;height: 300px;margin-left:30px ; padding: 5px;">
                        <br>
                        <h6  class="d-inline-block bg-light  text-uppercase py-1 px-2">Scrub</h6>
